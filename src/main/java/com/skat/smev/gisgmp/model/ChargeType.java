 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="SupplierBillID" type="{http://roskazna.ru/gisgmp/xsd/Common/2.0.1}SupplierBillIDType" maxOccurs="10"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
@XmlType(name = "ChargeType", namespace = "http://roskazna.ru/gisgmp/xsd/Charge/2.0.1", propOrder = {
...
public class ChargeType {
    ...
    @XmlElement(name = "LinkedChargesIdentifiers", namespace = "http://www.w3.org/2001/XMLSchema")
    protected ChargeType.LinkedChargesIdentifiers linkedChargesIdentifiers;
    @XmlElement(name = "Payee", required = true, namespace = "http://roskazna.ru/gisgmp/xsd/Organization/2.0.1")
    ...
    @XmlAttribute(name = "supplierBillID", required = true, namespace = "http://roskazna.ru/gisgmp/xsd/Common/2.0.1")
    ...
    public static class LinkedChargesIdentifiers {
        ...
        @XmlElement(name = "SupplierBillID", namespace = "http://roskazna.ru/gisgmp/xsd/Charge/2.0.1", required = true)
